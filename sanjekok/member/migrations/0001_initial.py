    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('m_sex', models.CharField(choices=[('male', '남자'), ('female', '여자')], max_length=6, verbose_name='성')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('member_industry', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member_industry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='individuals', to='member.member_industry', verbose_name='회원 업종')),
            ],
            options={
                'verbose_name': '개인산재정보',
